# -*- coding: utf-8 -*-
"""M25MAC004_prob4.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/14NdPBTFUxRdk21H4xVcTdAfYZYF4Lser
"""
...
class Models_Training:
    ...
    def logistic_regression(self):
        ...
        pipe_Logistic = PipelineScratch([
            ('tfidf_vectorization', TfidfVectorizerScratch()),
    ...
    def DecisionTree(self):
        X_train, X_test, y_train, y_test = train_test_split(self.X, self.y, test_size=0.33, random_state=101)
        pipe_DT = PipelineScratch([
            ('tfidf_vectorization', TfidfVectorizerScratch()),
            ('model', DecisionTreeScratch(max_depth=15, min_samples_split=5))])
